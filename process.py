...
class ModuloProcessamento:
    ...
    def Geral(self, opc):
        diretorio = listdir(r'C:\Users\u300310\OneDrive - HUB FINTECH S A\PycharmProjects\Hubfintech\logs_q2')
        dicionario = dict()
        conjunto = []
        field39 = ''
        for file in diretorio:
            arquivo = open(f'C:\\Users\\u300310\\OneDrive - HUB FINTECH S A\\PycharmProjects\\Hubfintech\\logs_q2\\{file}', 'r', encoding='utf-8')
            v = True
            while v:
        ...
        if opc:
            ...
            print('CHAMOU O MODULO DE SALVAR')
    ...
    def NewExcel(self, conjunto):
        ...
        #worksheet = worksheet.title(u'Transações')
        worksheet['A1'] = 'Data'
        worksheet['B1'] = 'MTI'
    ...
    def escreverjson(self, nome, lista):
        data = date.today()
        with open(f'Resultados\{nome}.json', 'ab') as f:
            dict_salvar = json.dumps(lista, indent=4, sort_keys=False)
            f.write(dict_salvar.encode())

    def Desfazimentos(self):
        diretorio = listdir(r'C:\Users\u300310\PycharmProjects\Hubfintech\logs_q2')
        conjunto_desfazimento = []
        field39 = ''
        cont = 0
        for file in diretorio:
            arquivo = open(f'C:\\Users\\u300310\\PycharmProjects\\Hubfintech\\logs_q2\\{file}', 'r', encoding='utf-8')
            v = True
            while v:
                linha = arquivo.readline()
                if linha.__contains__('<'):
                    if linha.__contains__('<log realm="mastercard-channel/'):
                        ...
                        if linha.__contains__('<field id="0" value="0420"/>'):
                            ...
                            if field2.__contains__('______'):
                                field3 = arquivo.readline().strip(" ")
                                field4 = arquivo.readline().strip(" ")
                                field5 = arquivo.readline().strip(" ")
                                field6 = arquivo.readline().strip(" ")
                                field7 = arquivo.readline().strip(" ")
                                field9 = arquivo.readline().strip(" ")
                                field10 = arquivo.readline().strip(" ")
                                field11 = arquivo.readline().strip(" ")
                                linha = arquivo.readline().strip(" ")
                                while not linha.__contains__('<field id="39" value="'):
                                    linha = arquivo.readline().strip(" ")
                                    if linha.__contains__('<field id="39" value="'):
                                ...
                                while not linha.__contains__('<isomsg id="90">'):
                                    ...
                                    if linha.__contains__('<isomsg id="90">'):
                                        arquivo.readline()
                                        field90_1 = arquivo.readline().strip(" ")
                                        field90_2 = arquivo.readline().strip(" ")
                                        field90_3 = arquivo.readline().strip(" ")
                                        conjunto_desfazimento += ({f'{log}{field0}{field2}{field3}{field4}{field5}{field6}{field7}{field9}{field10}{field11}{field39}{field90_1}{field90_2}{field90_3}</log>'})
                if len(linha) == 0:
                    v = False
                    arquivo.close()

        return conjunto_desfazimento
            ...
            while v:
                ...
                if linha.__contains__('<'):
                    if linha.__contains__('<log realm="mastercard-channel/'):
                        ...
                        linha = arquivo.readline()
                        linha = arquivo.readline()
                        if linha.__contains__('<field id="0" value="0100"/>'):
                            cont += 1
                            field0 = linha.strip(" ")
                            field2 = arquivo.readline().strip(" ")
                            if field2.__contains__('______'):
                                ...
                                linha = arquivo.readline().strip(" ")
                                conjunto += ({
                                    f'{log}{field11}{field0}{field2}{field3}{field4}{field5}{field6}{field7}{field9}{field10}{field39}</log>'})
